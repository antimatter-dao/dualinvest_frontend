...
import { BTC, ETH, USDT, MATTER } from 'constants/index'
  ...
  const balanceData = useMemo(() => {
    return accountBalances
      ? [
          ...
          [
            <TokenHeader key="matter" token={MATTER} />,
